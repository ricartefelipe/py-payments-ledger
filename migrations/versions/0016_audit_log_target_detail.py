"""Alinhar audit_log ao ORM (target, detail) em BD legada.

Revision ID: 0016_audit_log_target_detail
Revises: 0015_upsert_policies_abac
Create Date: 2026-04-03

Staging/produção com tabela estilo Core (resource_type, path, details, …)
sem as colunas esperadas pelo SQLAlchemy causa falha em _audit e na API.
"""
...
revision: str = "0016_audit_log_target_detail"
down_revision: Union[str, None] = "0015_upsert_policies_abac"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None


def _backfill_audit_target_from_legacy_columns(cols: set[str]) -> None:
    """SQL estático (sem f-string) para satisfazer Semgrep / evitar injeção."""
